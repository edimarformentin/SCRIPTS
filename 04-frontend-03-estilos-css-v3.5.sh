...
# Script 04-frontend-03: Estilos CSS (v3.5 - Ajuste no Grid do Card)
# =================================================================

echo "--> 4.3: Aplicando estilos (v3.5 - Ajuste no Grid do Card)..."
mkdir -p "$FRONTEND_DIR/css"

echo "    -> Criando css/cameras.css com ajuste de grid para o card de cliente..."
...
echo "--- Tema (v3.5) com ajuste de grid para o card de cliente aplicado com sucesso."
