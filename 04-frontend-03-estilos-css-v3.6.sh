...
# Script 04-frontend-03: Estilos CSS (v3.6 - Estilo do Indicador de Gravação)
#
# Adiciona a classe de estilo para o novo indicador de dias de gravação.
# =================================================================

echo "--> 4.3: Aplicando estilos (v3.6 - Estilo do Indicador de Gravação)..."
mkdir -p "$FRONTEND_DIR/css"

# --- cameras.css (COM O ESTILO DO INDICADOR DE GRAVAÇÃO) ---
echo "    -> Criando css/cameras.css com estilo para o indicador de gravação..."
...
.item-actions { flex-basis: 150px; text-align: right; }
...
echo "--- Tema (v3.6) com estilo para o indicador de gravação, aplicado com sucesso."
