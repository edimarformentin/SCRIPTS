...
# Script 1.4.1: Serviços Docker Compose (v4.8 - Build Path Fix)
#
# - Corrige a sintaxe da diretiva 'build' para ser explícita.
# =================================================================

echo "--> 1.4.1: Configurando os serviços com Docker Compose (v4.8)..."
...
echo "    -> Criando arquivo docker-compose.yml com sintaxe de build corrigida..."
...
services:
  ...
  orquestrador:
    ...
    networks: [vaas-network]
COMPOSE_EOF
echo "--- Configuração dos serviços (v4.8 ) concluída."
