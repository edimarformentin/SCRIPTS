...
# Script 04-frontend-02: Página de Câmeras (v5.2 - Correção Final da IA)
#
# Corrige o bug da IA na aba RTSP, destruindo e recriando a instância
# do Choices.js a cada troca de aba, garantindo que ela sempre
# inicialize em um elemento visível.
# =================================================================

echo "--> 4.2: Criando a página de câmeras (v5.2 - Correção Final da IA)..."
mkdir -p "$FRONTEND_DIR/js"

# --- Recria o cameras.html (v5.0) que já estava correto ---
echo "    -> Recriando cameras.html (v5.0)..."
...
# --- cameras.js (COM A LÓGICA DE REINICIALIZAÇÃO DA IA ) ---
echo "    -> Criando js/cameras.js (v5.2) com reinicialização da IA a cada troca de aba..."
...
const App = {
    ...
    initializeChoices() {
        ...
        // Destrói instâncias antigas se existirem, para evitar memory leaks
        ...
        // Inicializa a instância de EDIÇÃO (que está sempre disponível no modal)
        ...
        // Inicializa a instância de ADIÇÃO apenas na aba ATIVA
    ...
    setupEventListeners() {
        ...
        // Adiciona a lógica de reinicialização ao trocar de aba
        document.querySelectorAll('.tab-link').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                // REINICIALIZA O CHOICES NA NOVA ABA ATIVA
                this.initializeChoices();
            });
        });
...
echo "--- Script 04-frontend-02 (v5.2) com correção final da IA, atualizado com sucesso. ---"
