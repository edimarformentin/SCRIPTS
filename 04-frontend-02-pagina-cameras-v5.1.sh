...
# Script 04-frontend-02: Página de Câmeras (v5.1 - Correção do Reset da IA)
#
# Substitui 'clearStore()' por 'removeActiveItems()' para limpar a seleção
# de IA sem remover as opções disponíveis, corrigindo o bug pós-cadastro.
# =================================================================

echo "--> 4.2: Criando a página de câmeras (v5.1 - Correção do Reset da IA)..."
...
# --- cameras.js (COM A CORREÇÃO DO RESET DA IA ) ---
echo "    -> Criando js/cameras.js (v5.1) com correção do reset da IA..."
...
const App = {
    ...
    async handleAddFormSubmit(e) {
        ...
        try {
            ...
            // Limpa apenas os itens selecionados, mantendo as opções disponíveis.
...
echo "--- Script 04-frontend-02 (v5.1) com correção do reset da IA, atualizado com sucesso. ---"
