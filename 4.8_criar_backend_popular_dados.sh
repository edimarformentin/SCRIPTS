#!/bin/bash
# Nome do arquivo: 4.8_criar_backend_popular_dados.sh (v3 - com retenção de eventos)
set -Eeuo pipefail

echo "==== SCRIPT 4.8 (v3): ATUALIZANDO SCRIPT DE POPULAÇÃO DE DADOS ===="

cd /home/edimar/SISTEMA

echo "--> Gerando GESTAO_WEB/popular_dados.py com o campo 'ia_event_retention_days'..."

cat <<'POPULATE_PY_EOF' > GESTAO_WEB/popular_dados.py
...
echo "--> Arquivo popular_dados.py atualizado com sucesso."
echo "==== SCRIPT 4.8 (v3) CONCLUÍDO ===="
