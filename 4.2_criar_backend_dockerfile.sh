#!/bin/bash
# Nome do arquivo: 4.2_criar_backend_dockerfile.sh
# Função: Cria o Dockerfile para o serviço de backend (gestao_web).

set -Eeuo pipefail

echo "==== SCRIPT 4.2: CRIANDO DOCKERFILE DO BACKEND ===="

# Navega para o diretório raiz do sistema.
cd /home/edimar/SISTEMA

echo "--> Gerando GESTAO_WEB/Dockerfile..."

# Usa 'cat' com 'EOF' para escrever o conteúdo do Dockerfile.
# O arquivo será sobrescrito se já existir, garantindo idempotência.
cat <<'DOCKERFILE' > GESTAO_WEB/Dockerfile
