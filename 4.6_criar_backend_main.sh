#!/bin/bash
# Nome do arquivo: 4.6_criar_backend_main.sh (v12 - com novo local de script)
set -Eeuo pipefail
echo "==== SCRIPT 4.6 (v12): ATUALIZANDO MAIN.PY (com novo local de script) ===="
cd /home/edimar/SISTEMA
echo "--> Gerando GESTAO_WEB/main.py com caminho atualizado para o limpador..."

cat <<'MAIN_PY_EOF' > GESTAO_WEB/main.py
...
echo "--> Script 4.6 (v12) atualizado com sucesso."
echo "==== SCRIPT 4.6 (v12) CONCLUÍDO ===="
