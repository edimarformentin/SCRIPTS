...
# Script 04-frontend-02: Página de Câmeras (v4.6 - Card de Cliente Melhorado)
# =================================================================

echo "--> 4.2: Criando a página de câmeras (v4.6 - Card de Cliente Melhorado)..."
mkdir -p "$FRONTEND_DIR/js"

echo "    -> Criando js/cameras.js com o card de informações do cliente aprimorado..."
...
echo "--- Script 04-frontend-02 (v4.6) com card de cliente melhorado, atualizado com sucesso. ---"
