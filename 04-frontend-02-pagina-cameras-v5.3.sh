...
# Script 04-frontend-02: Página de Câmeras (v5.3 - Opções de Gravação Expandidas)
#
# Altera os dropdowns de dias de gravação para oferecer opções de 1 a 7 dias.
# =================================================================

echo "--> 4.2: Criando a página de câmeras (v5.3 - Opções de Gravação Expandidas)..."
mkdir -p "$FRONTEND_DIR/js"

# --- cameras.html (COM DROPDOWNS DE GRAVAÇÃO ATUALIZADOS) ---
echo "    -> Criando cameras.html (v5.3) com opções de gravação expandidas..."
...
# --- Recria o cameras.js (v5.2 ) que já estava correto ---
echo "    -> Recriando js/cameras.js (v5.2)..."
...
echo "--- Script 04-frontend-02 (v5.3) com opções de gravação expandidas, atualizado com sucesso. ---"
