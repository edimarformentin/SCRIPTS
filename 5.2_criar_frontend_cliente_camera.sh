#!/bin/bash
# Nome do arquivo: 5.2_criar_frontend_cliente_camera.sh (v15 - com confirmação inteligente)
set -e
echo "==== FRONTEND (2/3): Adicionando confirmação inteligente de limpeza... ===="
cd /home/edimar/SISTEMA

# O template ver_cliente.html não precisa de mudanças, mas o recriamos para manter o script consistente.
echo "--> Gerando ver_cliente.html (v15)"
cat <<'HTML_VER_CLIENTE' > GESTAO_WEB/templates/ver_cliente.html
{% extends "base.html" %}
...
# 2. TEMPLATE EDITAR_CAMERA (com a lógica de confirmação inteligente)
echo "--> Gerando editar_camera.html (v15) com confirmação inteligente"
cat <<'HTML_EDITAR_CAMERA' > GESTAO_WEB/templates/editar_camera.html
{% extends "base.html" %}
...
echo "==== PARTE 2/3 CONCLUÍDA (com confirmação inteligente) ===="
